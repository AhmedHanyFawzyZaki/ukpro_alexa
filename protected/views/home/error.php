...
<html lang="en">
    <head>
        ...
        <link type="text/css" rel="stylesheet" href="<?php echo Yii::app()->request->getBaseUrl(true); ?>/css/style.css">
    </head>
    <body>
        <div class="header">
        ...
        <div class="content">
            ...
            <div class="content2">
                ...
                <img class="pull-right error_img" src="<?= Yii::app()->request->getBaseUrl(true) ?>/media/<?php echo Yii::app()->params['error_image']; ?>" width="600px">
                ...
                <div class="error_left_part">
                    ...
                    <div class="error_btns text-center">
                        ...
                        if (Yii::app()->params['error_homeactive'] == 1) {
                            ...
                            <a href="<?= Yii::app()->request->getBaseUrl(true) ?>/home/index" class="btn error_page_btn">
                        ...
                        if (Yii::app()->params['error_prevactive'] == 1) {
                            ...
                            <a href="<?= $_SERVER['HTTP_REFERER'] ? $_SERVER['HTTP_REFERER'] : Yii::app()->request->getBaseUrl(true) . '/home/index' ?>" class="btn error_page_btn">
