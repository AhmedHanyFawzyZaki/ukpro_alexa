...
class PagesController extends AdminController
{
	...
	public function actionCreate()
	{
		...
		if(! empty ($uploadedFile2)){
			...
			$uploadedFile2->saveAs(Yii::app()->basePath.'/../media/pages/'.$fileName);
	   	}
	...
	public function actionUpdate($id)
	{
		...
		if(isset($_POST['Pages']))
		{
                    ...
                    if(! empty ($uploadedFile2)){
                        ...
                        $uploadedFile2->saveAs(Yii::app()->basePath.'/../media/pages/'.$model->video);
                    }
                    $model->slug = Helper::slugify($model->title);
                    if($model->save())
                    {
	...
	public function actionDeleteimage($id)
	{
		if($id != ''){
	   	$model= $this->loadModel($id)	;
		    @unlink(Yii::app()->basePath.'/../media/pages/'.$model->image);
