 ...
 */
class BlogComment extends SortableCActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			...
			array('blog_id, user_id, approve, sort', 'numerical', 'integerOnly'=>true),
			array('comment', 'length', 'max'=>255),
			array('create_date', 'safe'),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, blog_id, comment, user_id, approve, create_date, sort', 'safe', 'on'=>'search'),
		);
	}
